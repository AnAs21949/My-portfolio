    ...
    <section id="projects-section" className="bg-gray-950  p-16 ">
      ...
      <div className="flex flex-col gap-40 items-center justify-center mt-10">
        <div className="flex flex-col  items-center justify-center">
          ...
          {/* <a href="https://anas21949.github.io/Space-tourism-multi-page-website/">
          </a>
          <a href="https://anas21949.github.io/Space-tourism-multi-page-website/">
          </a> */}
        </div>
        ...
        <div className="flex flex-col  items-center justify-center">
          ...
          {/* <a href="https://anas21949.github.io/little-lemonv2/">
          </a>
          <a href="https://anas21949.github.io/little-lemonv2/">
          </a> */}
        </div>
        ...
        <div className="flex flex-col  items-center justify-center">
          ...
          {/* <a href="http://127.0.0.1:5500/bookmark-landing-page/index.html/">
          </a>
          <a href="http://127.0.0.1:5500/bookmark-landing-page/index.html/">
          </a> */}
        </div>
        ...
        <div className="flex flex-col  items-center justify-center">
          ...
          {/* <a href="https://anas21949.github.io/todo/">
          </a>
          <a href="https://anas21949.github.io/todo/">
          </a> */}
        </div>
