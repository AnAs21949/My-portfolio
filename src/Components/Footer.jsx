    ...
    <section className='bg-slate-900 p-16 text-white flex flex-col font-mono'>
      <div className="flex flex-col md:flex-row gap-20 items-center justify-between ">
        <div className="">
          ...
          <p className="max-w-lg"> A Frontend focused Web Developer
             building the Frontend of Websites and Web Applications that leads to the success of the overall product
          </p>
        </div>
      ...
      <div className="text-center">
        <p className="font-mono mt-5"> © Copyright 2023. Made by <a className="underline" href="">ANAS ABID</a> </p>
      </div>
